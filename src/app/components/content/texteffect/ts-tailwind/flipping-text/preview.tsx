...
const SocialIcon: React.FC<SocialIconProps> = ({ platform }) => {
  ...
  return (
    <div className="relative w-12 h-12 cursor-pointer overflow-hidden rounded-lg border-2 border-gray-300">
      <svg
        width="48"
        height="48"
        viewBox="0 0 24 24"
...
const FlippingText: React.FC<FlippingTextProps> = ({
  ...
  return (
    <motion.div
      ...
      initial="rest"
      animate="rest"
      className={`flex justify-center items-center flex-col gap-4 group cursor-pointer ${
